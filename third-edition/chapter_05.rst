...
When you ran ``django-admin startproject mysite`` in Chapter 1, Django created
and configured the default admin site for you. All that you need to do is
create an admin user (superuser) and then you can log into the admin site.
...
.. figure:: graphics/chapter_05/admin01.png
   
   Figure 5-1: Django admin login screen

Since translation is turned on by default, the login screen may be displayed
...
.. figure:: graphics/chapter_05/admin02.png
...
.. figure:: graphics/chapter_05/user_changelist.png
...
.. figure:: graphics/chapter_05/user_editform.png
...
.. figure:: graphics/chapter_05/user_editform_errors.png
...
.. figure:: graphics/chapter_05/user_history.png
...
Chapter 4, where we defined three models: ``Publisher``, ``Author`` and
``Book``.

Within the ``books`` directory (``mysite/books``), ``startapp`` should have created a file called
...
the ``__str__()`` method, our models have served as definitions of our
...
statements (which were covered in Chapter 4) add an explicit ``NOT NULL`` to
...
``python manage.py migrate`` command whenever you make such a change to a model.
...
list displays the result of ``__str__()`` for each object. In Chapter 4, we
defined the ``__str__()`` method for ``Author`` objects to display the
...
.. figure:: graphics/chapter_05/author_changelist3.png
...
common cases for filtering by date. Figure 5-10 shows what that looks like.

.. figure:: graphics/chapter_05/book_changelist1.png
...
.. figure:: graphics/chapter_05/book_changelist2.png
...
the records are sorted. (See Figure 5-12.)

.. figure:: graphics/chapter_05/book_changelist3.png
...
.. figure:: graphics/chapter_05/book_editform1.png
...
.. figure:: graphics/chapter_05/book_editform2.png
