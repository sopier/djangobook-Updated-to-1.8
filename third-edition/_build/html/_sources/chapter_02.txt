...
.. admonition:: Your Python Path
    ...
    '/usr/lib/python3.4/site-packages', '/home/username/djcode']``. If you
    ...
    ``/usr/lib/python3.4/site-packages/foo.py``. If that file doesn't exist, it
...
.. admonition:: Django's Time Zone
    ...
    That's because Django is time zone-aware and defaults to the ``UTC`` time
    zone. If you live elsewhere, you'll want to change it in ``settings.py``.
