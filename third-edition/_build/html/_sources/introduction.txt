...
Adrian and Jacob have long since "retired" from the project,
but the fundamentals of what drove them to create Django live on in the
project. It is this solid base of real-world experience that has made Django
as successful as it is. 

In recognition of their contribution, I think it best we let them introduce
Django in their own words.
